@testset "Constrains" begin
   ...
   @testset "single addition" begin
      ...
      @test isa((Ordered_con_c_b +  Ordered_con_a_b),BOMoD.Compose_Construct_Constrains) == true
   ...
   @testset "mulitple_additions" begin
      ...
      @test  isa(sum([Ordered_con_c_b +  Ordered_con_a_b + Unordered_con_c_e]),BOMoD.Compose_Construct_Constrains) == true
   end
